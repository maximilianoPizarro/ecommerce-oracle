...
```
sdk install java 17.0.3-ms && sdk default java 17.0.3-ms && npm install -g generator-jhipster-quarkus
```

```
jhipster-quarkus
./mvnw quarkus:add-extension -Dextensions="io.quarkus:quarkus-jdbc-oracle"
```