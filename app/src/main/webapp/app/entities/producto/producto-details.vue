    ...
    <div class="col-8">
      <div v-if="producto">
        <h2 class="jh-entity-heading" data-cy="productoDetailsHeading">
          <span v-text="t$('ecommerceApp.producto.detail.title')"></span> {{ producto.id }}
        </h2>
        <dl class="row jh-entity-details">
          <dt>
            <span v-text="t$('ecommerceApp.producto.nombre')"></span>
          </dt>
          <dd>
            <span>{{ producto.nombre }}</span>
          </dd>
          <dt>
            <span v-text="t$('ecommerceApp.producto.descripcion')"></span>
          </dt>
          <dd>
