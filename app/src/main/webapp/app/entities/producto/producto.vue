<template>
  <div>
    <h2 id="page-heading" data-cy="ProductoHeading">
      <span v-text="t$('ecommerceApp.producto.home.title')" id="producto-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('ecommerceApp.producto.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'ProductoCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('ecommerceApp.producto.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && productos && productos.length === 0">
      <span v-text="t$('ecommerceApp.producto.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="productos">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="t$('ecommerceApp.producto.nombre')"></span></th>
            <th scope="row"><span v-text="t$('ecommerceApp.producto.descripcion')"></span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span id="ecommerceApp.producto.delete.question" data-cy="productoDeleteDialogHeading" v-text="t$('entity.delete.title')"></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-producto-heading" v-text="t$('ecommerceApp.producto.delete.question', { id: removeId })"></p>
      </div>
